...
unsigned int evictParents (unsigned int node, graph* G1, graph* G2, unsigned int* CI, unsigned int* cost, unsigned int* cachePresence, bool* isPlaced, unsigned int* nodeId, unsigned int* nodeMap, unsigned int* outDeg, unsigned int* updates, unsigned int thresh)
{
...
unsigned int loadParents (unsigned int nodePtr, graph* G1, graph* G2, unsigned int* CI, unsigned int* cost, unsigned int* cachePresence, bool* isPlaced, unsigned int* nodeId, unsigned int* nodeMap, unsigned int* outDeg, unsigned int* updates, unsigned int thresh, unsigned int minPtr)
{
